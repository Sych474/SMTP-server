...
#define MAIL_FROM_ALIAS "(MAIL FROM:|X-From:)"
#define RCPT_TO_ALIAS "(RCPT TO:|X-Original-To:)"

#define HELO_REGEXP "HELO" DOMAIN_REGEXP EOS EOL
#define EHLO_REGEXP "EHLO" DOMAIN_REGEXP EOS EOL
#define MAIL_REGEXP MAIL_FROM_ALIAS SPACES_REGEXP ADDRESS_OR_EMPTY_REGEXP EOS EOL
#define RCPT_REGEXP RCPT_TO_ALIAS SPACES_REGEXP ADDRESS_REGEXP EOS EOL
